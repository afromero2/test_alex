...
/*agregado para obtener datos de la encuesta de usabilidad 09062017*/
global $USER, $DB;
if ($USER->id=='3'){
	$sql_usuario="select * from mdl_encuesta_usabilidad where userid='$USER->id' limit 1";
	$encuesta = $DB->get_records_sql($sql_usuario);
	if (!$encuesta and $USER->id=='3'){
		redirect($CFG->wwwroot."/enrol/utpl/usabilidad/index.php");
	}
}
/*fin encuensta usabilidad*/
